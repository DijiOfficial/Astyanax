...
public:
	...
	explicit Texture( const std::string& text, const std::string& fontPath, int ptSize, const Color4f& textColor, const bool isWrapped );
...
private:
	...
	void CreateFromString(const std::string& text, TTF_Font* pFont, const Color4f& textColor, const bool isWrapped = false);
	void CreateFromString( const std::string& text, const std::string& fontPath, int ptSize, const Color4f& textColor, const bool isWrapped = false);
